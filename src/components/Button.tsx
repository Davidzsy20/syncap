  ...
  return (
    <button
      ...
      className={clsx(
        ...
        className,
        variant === 'primary'
          ? ' border border-black px-4 py-3 hover:bg-gray-100 focus:ring focus:ring-primary-600 active:bg-gray-600'
          : '',
        variant === 'secondary'
          ? 'bg-primary-200 px-4 py-3 hover:brightness-110 focus:ring focus:ring-primary-100 active:bg-primary-200'
          : '',
        variant === 'outline'
          ? 'border-gray border-primary-1050 px-4 py-3 text-primary-1050 hover:border-gray-500  focus:ring-primary-1050 active:border-gray-600'
          : '',
        variant === 'checkbox'
          ...
          : '',
        variant === 'solid'
          ? 'focus:ring-offset bg-primary-1050 px-4 py-3 text-gray-100 hover:bg-primary-900 focus:ring-primary-500 active:bg-primary-800'
          : textColor,
        variant === 'transparent'
          ? 'focus:ring-offset bg-transparent p-2 text-primary-1050 hover:bg-primary-1050/20 focus:ring-primary-500 active:bg-primary-1050/20'
          : ''
      )}
    >
      {props.children}
